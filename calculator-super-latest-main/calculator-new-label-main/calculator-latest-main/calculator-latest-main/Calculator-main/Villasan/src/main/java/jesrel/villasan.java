...
public class villasan extends javax.swing.JFrame {
    ...
    private void jbtnModuloActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnModuloActionPerformed
        ...
        ans = num1 / 100;
        jlblOutput.setText(String.valueOf(ans));
    ...
    if (!currentNumber.isEmpty() && !operator.isEmpty()) {
            ...
            if (!Double.isInfinite(ans)) {
                ...
                jlblOutput.setText("Error: Division by zero");
            }

            // Reset num1 and num2 for subsequent operations
           
            operator = null;
            currentNumber = String.valueOf(ans); // Added this line
        } else {
    ...
    private void jbtnDotActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnDotActionPerformed
       if (!jlblOutput.getText().contains(".")) {
